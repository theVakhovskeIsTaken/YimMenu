...
namespace big
{
	...
	public:
		...
		struct reactions
		{
			...
			reaction ceo_join{"CEO Join", "REACTION_CEO_JOIN_NOTIFY", "REACTION_CEO_JOIN_ANNOUNCE"};
		...
		struct weapons
		{
			...
			struct aimbot
			{
				...
				NLOHMANN_DEFINE_TYPE_INTRUSIVE(aimbot, enable, target_drivers)
			} aimbot{};
